<x-app-layout title="{{ Session::get('user')[0]->name }}">
    <div class="card">
        <div class="row g-0">
                ...
                <div class="card-body">
                    ...
                    <div class="row align-items-center">
                        <div class="col-auto"><span class="avatar avatar-xl"
                                style="background-image: url({{ Session::get('user')[0]->avatar }})"></span>
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md">
                            ...
                            <input type="text" class="form-control" value="{{ Session::get('user')[0]->name }}">
                        </div>
                        <div class="col-md">
                        <div class="col-md">
                    ...
                    <div>
                        <div class="row g-2">
                            <div class="col-auto">
                                <input type="text" class="form-control w-auto" value="{{ Session::get('user')[0]->email }}">
                            </div>
